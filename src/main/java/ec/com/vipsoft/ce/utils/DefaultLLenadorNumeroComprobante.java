...
public class DefaultLLenadorNumeroComprobante implements LlenadorNumeroComprobante {
	...
	/* (non-Javadoc)
	 * @see ec.com.vipsoft.ce.utils.LlenadorNumeroComprobante#llenarNumeroDocumento(java.lang.String)
	 */
	@Override
	public String llenarNumeroDocumento(String numero){
        ...
        StringBuilder sb=new StringBuilder();
        sb.append(primero).append("-").append(segundo).append("-").append(tercero);
        return sb.toString();
}
}
